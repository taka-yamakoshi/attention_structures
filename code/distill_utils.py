...
def gen_run_name(args):
    ...
    bias_stat = f'{args.pretrained_model_name}_{args.distill_type}'
    if args.distill_type=='attns' and args.shuffle is not None:
        bias_stat += f'_shuffle_{args.shuffle}'
    bias_stat += f'_{args.beta}'
